# copied and pasted from ryurko's nflscrapr-data script -----------------------------------------
...
system.time(pbp_2010 <- purrr::map_dfr(game_ids_10, game_play_by_play) %>%
  dplyr::mutate(Season = 2010))
length(unique(pbp_2010$GameID)) == 256

system.time(pbp_2011 <- purrr::map_dfr(game_ids_11, game_play_by_play) %>%
  dplyr::mutate(Season = 2011))
length(unique(pbp_2011$GameID)) == 256

system.time(pbp_2012 <- purrr::map_dfr(game_ids_12, game_play_by_play) %>%
  dplyr::mutate(Season = 2012))
length(unique(pbp_2012$GameID)) == 256

system.time(pbp_2013 <- purrr::map_dfr(game_ids_13, game_play_by_play) %>%
  dplyr::mutate(Season = 2013))
length(unique(pbp_2013$GameID)) == 256

system.time(pbp_2014 <- purrr::map_dfr(game_ids_14, game_play_by_play) %>%
  dplyr::mutate(Season = 2014))
length(unique(pbp_2014$GameID)) == 256

system.time(pbp_2015 <- purrr::map_dfr(game_ids_15, game_play_by_play) %>%
  dplyr::mutate(Season = 2015))
length(unique(pbp_2015$GameID)) == 256

system.time(pbp_2016 <- purrr::map_dfr(game_ids_16, game_play_by_play) %>%
  dplyr::mutate(Season = 2016))
length(unique(pbp_2016$GameID)) == 256

system.time(pbp_2017 <- purrr::map_dfr(game_ids_17, game_play_by_play) %>%
...
# Each file is saved individually (SG: Using RDS rather than Yurko's CSV)
saveRDS(pbp_2009, file = "./data/season_play_by_play/pbp_2009.rds")
saveRDS(pbp_2010, file = "./data/season_play_by_play/pbp_2010.rds")
saveRDS(pbp_2011, file = "./data/season_play_by_play/pbp_2011.rds")
saveRDS(pbp_2012, file = "./data/season_play_by_play/pbp_2012.rds")
saveRDS(pbp_2013, file = "./data/season_play_by_play/pbp_2013.rds")
saveRDS(pbp_2014, file = "./data/season_play_by_play/pbp_2014.rds")
saveRDS(pbp_2015, file = "./data/season_play_by_play/pbp_2015.rds")
saveRDS(pbp_2016, file = "./data/season_play_by_play/pbp_2016.rds")
saveRDS(pbp_2017, file = "./data/season_play_by_play/pbp_2017.rds")
...
# Save each file
saveRDS(season_passing_df, "./data/season_player_stats/season_passing_df.rds")
...
saveRDS(team_season_receiving_df, "./data/season_team_stats/team_season_receiving_df.rds")
saveRDS(team_season_rushing_df, "./data/season_team_stats/team_season_rushing_df.rds")
...
# Save each file
saveRDS(team_game_passing_df, "./data/game_team_stats/game_passing_df.rds")
...
# Save these files:
saveRDS(team_2009_rosters, "./data/team_rosters/team_2009_rosters.rds")
saveRDS(team_2010_rosters, "./data/team_rosters/team_2010_rosters.rds")
saveRDS(team_2011_rosters, "./data/team_rosters/team_2011_rosters.rds")
saveRDS(team_2012_rosters, "./data/team_rosters/team_2012_rosters.rds")
saveRDS(team_2013_rosters, "./data/team_rosters/team_2013_rosters.rds")
saveRDS(team_2014_rosters, "./data/team_rosters/team_2014_rosters.rds")
saveRDS(team_2015_rosters, "./data/team_rosters/team_2015_rosters.rds")
saveRDS(team_2016_rosters, "./data/team_rosters/team_2016_rosters.rds")
saveRDS(team_2017_rosters, "./data/team_rosters/team_2017_rosters.rds")
...
# Save these files:
saveRDS(games_2009, "./data/season_games/games_2009.rds")
saveRDS(games_2010, "./data/season_games/games_2010.rds")
saveRDS(games_2011, "./data/season_games/games_2011.rds")
saveRDS(games_2012, "./data/season_games/games_2012.rds")
saveRDS(games_2013, "./data/season_games/games_2013.rds")
saveRDS(games_2014, "./data/season_games/games_2014.rds")
